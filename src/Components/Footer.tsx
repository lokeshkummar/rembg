  ...
  return (
    <footer className="mt-20 md:-mt-0">
      ...
      <div className="w-full py-3 bg-[#000000] border-t border-slate-700 text-center">
        <span className="text-xs text-[#02e797] opacity-80">Designed & Developed by <Link to='https://lokeshkummar.vercel.app/' className="hover:underline hover:text-sm ease-linear duration-200 hover:text-white hover:font-semibold">Lokesh Kumar</Link> With ❤️</span>
      </div>
    </footer>
  );
};
